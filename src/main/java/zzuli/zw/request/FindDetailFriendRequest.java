...
/**
 * @ClassName FindDetailFriendRequest
 * @Description TODO
 * @Author 索半斤
 * @Date 2021/2/12 20:45
 * @Version 1.0
 */
@Request(request = /*MessageType.REQUEST_FIND_DETAIL_FRIEND_INFO*/"")
public class FindDetailFriendRequest extends BaseRequest {
    ...
    public void doRequest(RequestParameter request, ResponseParameter response) throws IOException {
        ...
        //jsonResult.setStatus(RequestType.REQUEST_FIND_DETAIL_FRIEND_INFO);
